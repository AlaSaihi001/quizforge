        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-slate-400 leading-relaxed">
              Join thousands of students who use QuizForge to turn their notes
              into perfect study materials in seconds.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                required
                disabled={isLoading}
                className="h-11 border-slate-300 focus:border-violet-500 focus:ring-violet-500"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  disabled={isLoading}
                  className="h-11 border-slate-300 focus:border-violet-500 focus:ring-violet-500 pr-10"
                />
                <button
                  type="button"
